...
from slowapi import Limiter, _rate_limit_exceeded_handler #creates a limit, error response
from slowapi.util import get_remote_address #get user ip for limitng a specific user
...
def setup_security(app: FastAPI):
    ...
    app.add_middleware(
        CORSMiddleware,
        allow_origins=["http://localhost:3000", "any other url we need"],  # Update with your frontend URLs
